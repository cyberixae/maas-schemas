...
export const jsonSubscriptionAdditionsExamples: Array<unknown> = [null];
export const safeSubscriptionAdditionsExamples = t
  .array(SubscriptionAdditions)
  .decode(jsonSubscriptionAdditionsExamples);
