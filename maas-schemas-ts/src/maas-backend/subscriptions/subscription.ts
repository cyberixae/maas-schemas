...
export const jsonSubscriptionExamples: Array<unknown> = [];
...
export const jsonSubscriptionCreatePayloadExamples: Array<unknown> = [];
...
export const jsonSubscriptionUpdatePayloadExamples: Array<unknown> = [];
