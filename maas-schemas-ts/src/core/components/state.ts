...
export const jsonBookingStateExamples: Array<unknown> = [null];
...
export const jsonLegStateExamples: Array<unknown> = [null];
...
export const jsonItineraryStateExamples: Array<unknown> = [null];
